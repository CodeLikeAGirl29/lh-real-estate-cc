...
const projectContent = {
  ...
  "shadow-slate": {
    ...
    description: "An interactive mood board canvas where agents, designers, and buyers can drag furniture and finishes onto a room photo to preview a space in real time.",
  ...
  "okaloosa-guide": {
    ...
    description: "A working reference for the structural and infrastructure factors that actually move property value across Fort Walton Beach, Destin, and Shalimar.",
  ...
  "beyond-the-beach": {
    ...
    description: "A data-driven framework for reading Okaloosa County growth zones by infrastructure signal — permitting activity, fiber buildout, and zoning — instead of curb appeal.",
  ...
  "emerald-coast-insider": {
    ...
    description: "A curated lifestyle guide to daily life on the Emerald Coast, built to help relocating clients get a feel for the area beyond square footage.",
