...
export default function AboutStats() {
  return (
    <div className="w-full min-h-screen flex items-center bg-gray-900 py-20" id="stats">
      <div className="w-full lg:w-[85%] mx-auto px-4 sm:px-10 lg:px-0 flex flex-col gap-8 text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-16 mt-4">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-6">
              ...
              <SkillBar label="Property Valuation" percentage="88%" description="Comparative Market Analysis & Data Logic" />
              <SkillBar label="Local Market Knowledge" percentage="92%" description="Fort Walton Beach & Panhandle Specialist" />
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-6">
              ...
              <SkillBar label="Full-Stack Marketing" percentage="90%" description="SEO-optimized custom listing engines" />
              <SkillBar label="Database Management" percentage="80%" description="CRM integration & Lead Tracking" />
              <SkillBar label="Digital Security" percentage="85%" description="Ensuring safe, paperless transactions" />
            </div>

            <div className="grid grid-cols-2 gap-4 mt-8">
              <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                <span className="block text-2xl font-bold text-white">2026</span>
                <span className="text-xs text-gray-500 uppercase font-black">Licensed Year</span>
              </div>
              <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                <span className="block text-2xl font-bold text-white">100%</span>
                <span className="text-xs text-gray-500 uppercase font-black">Digital-First</span>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-6 p-8 bg-white/5 rounded-3xl border border-white/10 backdrop-blur-md">
          <div>
            <h4 className="text-xl font-bold">Ready to modernize your next transaction?</h4>
