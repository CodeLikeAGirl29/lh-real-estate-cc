      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl mb-20">
          ...
          <h3 className="font-display text-4xl md:text-5xl font-bold tracking-tight text-foreground uppercase leading-tight">
            The Hybrid <br />
            <span className="text-brass">Advantage</span>
          </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {specifications.map((spec) => (
            <div
              key={spec.id}
              className="frame p-8 border border-foreground/10 hover:border-brass/30 transition-colors duration-300 group"
            >
              <div className="mb-6 inline-flex h-12 w-12 items-center justify-center border border-foreground/10 text-brass text-xl group-hover:border-brass/40 transition-colors duration-300">
                {spec.icon}
              </div>
        ...
        <div className="mt-16 flex items-center justify-between border-t border-foreground/5 pt-8">
          ...
          <FaArrowRight className="text-foreground/30 group-hover:text-brass transition-colors duration-300" />
        </div>
      </div>
    </section>
  );
