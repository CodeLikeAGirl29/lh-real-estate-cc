...
import { FaUserShield, FaBriefcase, FaMicrochip, FaArrowRight } from "react-icons/fa6";
...
const specifications = [
  {
    ...
    icon: <FaUserShield />,
    title: "The Identity",
    content: "Decades of local immersion combined with a developer's eye. High-resolution views of Fort Walton Beach real estate are provided, ranging from zoning nuances to the long-term potential of specific coastal blocks."
  },
  {
    id: 2,
    icon: <FaBriefcase />,
    title: "The Work Ethic",
    content: "Built on high-pressure service and technical precision. The wrench and the brush have been traded for the code editor to build a more efficient way to move property."
  },
  {
    id: 3,
    icon: <FaMicrochip />,
    title: "The Engine",
    content: "The 'Florida Real Estate Master Drill' serves as a proof of concept. Full-stack tools (Next.js/Node) are engineered to ensure the absolute highest level of preparation."
  }
];

export default function AboutBlueprint() {
  return (
    <section className="bg-slate-950 py-24 border-t border-white/5 relative overflow-hidden" id="blueprint">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-2xl mb-20">
          ...
          <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-white uppercase leading-tight">
            The Hybrid <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-500">Advantage</span>
          </h3>
          <p className="mt-6 text-base font-sans text-slate-400 leading-relaxed">
            While technology is widely utilized across the industry, customized platforms are built directly from scratch here. This approach combines real estate licensure parameters with software engineering principles to deliver advanced analysis for the Fort Walton Beach market.
          </p>
        </div>
