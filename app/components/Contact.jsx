        ...
        <div className="grid lg:grid-cols-2 items-center gap-8">
          ...
          <div className="py-8 px-8 sm:px-10 bg-gray-100 rounded-3xl">
            ...
            <p className="text-[15px] text-slate-600 mt-4 leading-relaxed">
              Have a specific inquiry? I am ready to engage with you to find your perfect home.
            </p>
            ...
            {status === 'success' ? (
              <div className="mt-8 flex flex-col items-center justify-center p-8 bg-white rounded-xl border border-green-100 animate-in fade-in zoom-in duration-300">
                ...
                <p className="text-gray-600 mt-2 text-center text-sm">I'll get back to you as soon as possible.</p>
                <button
            ...
            <ul className="mt-4 flex flex-wrap justify-center gap-4 lg:space-x-6 max-lg:flex-col max-lg:items-center max-lg:space-y-2">
              <li className="flex items-center text-blue-700 font-medium">
                ...
                <a href="mailto:info@lhrealestate.cc" className="text-current text-sm ml-3">info@lhrealestate.cc</a>
              </li>
              <li className="flex items-center text-blue-700 font-medium">
                ...
                <a href="tel:+18505335877" className="text-current text-sm ml-3">+1 (850) 533-5877</a>
              </li>
            </ul>
          </div>
          ...
          <div className="z-10 relative h-full max-lg:min-h-[400px] rounded-3xl overflow-hidden shadow-lg border border-gray-100">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110115.46781216592!2d-86.6974127978718!3d30.43231362615413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88913f416f5c8c63%3A0xc07a83d7350f9689!2sFort%20Walton%20Beach%2C%20FL!5e0!3m2!1sen!2sus!4v1712415000000!5m2!1sen!2sus"
