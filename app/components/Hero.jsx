        ...
        <div className="mx-auto w-screen max-w-7xl px-4 py-32 sm:px-6 lg:px-8 relative z-10">
          <div className="mx-auto max-w-prose text-center">
            ...
            <h1 className="text-5xl font-extrabold text-gray-900 sm:text-8xl dark:text-white leading-[0.9] tracking-tighter">
              Home,<br />
              <span className="text-indigo-600 italic">Handled.</span>
            </h1>

            <p className="mt-8 text-base text-pretty text-gray-700 sm:text-xl/relaxed dark:text-gray-400 max-w-lg mx-auto">
              Deploying <span className="text-indigo-400 font-mono">high-performance</span> marketing and structural precision to the Panhandle. Where local expertise meets a <span className="text-white font-semibold underline decoration-indigo-500 underline-offset-4">developer’s edge</span>.
            </p>

            <div className="mt-10 flex flex-wrap justify-center gap-4">
              {/* Primary Action */}
              <a
                className="inline-block rounded-full bg-indigo-600 px-10 py-4 text-sm font-bold text-white shadow-xl shadow-indigo-500/20 transition-all hover:bg-indigo-700 hover:scale-105 active:scale-95"
                href="#projects"
              >
                View Innovations
              </a>
