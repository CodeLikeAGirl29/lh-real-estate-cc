    ...
    <main className="min-h-screen bg-gray-900">
      ...
      <div className="relative pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <Typography variant="h1" className="text-5xl md:text-7xl font-serif text-white mb-6">
          ...
          <Typography className="max-w-2xl mx-auto text-gray-400 text-lg md:text-xl leading-relaxed">
            I don’t just show properties; I analyze the data, understand the structure,
            and engineer a seamless transition for every client.
          </Typography>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold text-white mb-8 border-l-4 border-sky-500 pl-6">
              My Mission: Living Handled
            </h2>
            <Typography className="text-gray-400 text-lg mb-6 leading-relaxed">
              With a background in <span className="text-sky-400">high-volume sales</span> and <span className="text-sky-400">web development</span>,
              I bring a unique perspective to the Florida Panhandle market.
              I believe real estate should be high-tech but high-touch—where every detail is managed with the precision of a codebase.
            </Typography>
            <Typography className="text-gray-400 text-lg mb-8 leading-relaxed">
              Currently based in <span className="text-indigo-400">Fort Walton Beach</span>, I am preparing to bridge
              the gap between traditional service and modern digital intelligence.
            </Typography>
